...
.LC0:
	...
	.section	.text.Base::virtualMethod(),"axG",@progbits,Base::virtualMethod(),comdat
	.align 2
	.weak	Base::virtualMethod()
	.type	Base::virtualMethod(), @function
Base::virtualMethod():
.LFB3:
	.cfi_startproc
	endbr64
	...
	.cfi_endproc
.LFE3:
	.size	Base::virtualMethod(), .-Base::virtualMethod()
	.section	.rodata
.LC1:
	.string	"Method says: "
	.section	.text.Base::method(),"axG",@progbits,Base::method(),comdat
	.align 2
	.weak	Base::method()
	.type	Base::method(), @function
Base::method():
.LFB4:
	.cfi_startproc
	endbr64
...
.LC2:
	...
	.section	.text.Derived::virtualMethod(),"axG",@progbits,Derived::virtualMethod(),comdat
	.align 2
	.weak	Derived::virtualMethod()
	.type	Derived::virtualMethod(), @function
...
.LFB8:
	...
	.cfi_endproc
.LFE8:
	.size	Derived::virtualMethod(), .-Derived::virtualMethod()
	.text
	.globl	main
	.type	main, @function
main:
